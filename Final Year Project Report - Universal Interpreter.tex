	...
	\lhead{\titleref{chapter4}}
		...
		\section{Android Application Implementation}
			...
			\subsection{Design Ideologies}
				...
				\begin{figure}[h]
					\centering
					\subfloat[Previously Received Message]{{\includegraphics[width=6cm]{ColourSelect.jpeg} }}%
					\qquad
					\subfloat[New Received Message]{{\includegraphics[width=6cm]{ReadMessage.jpeg} }}%
